...
path='/mnt/Storage/home/qinq/TCGA/COAD/'
...
for d in dirs:
    if d.startswith(disease+'_Batch'):
        ...
        if 'miRNASeq' in dirs2:
            batchid=d.split('_')[1][5:]
            dirs3=os.listdir(path+d+'/miRNASeq')
            for d3 in dirs3:
                if d3.startswith('BCGSC__IlluminaGA'):
...
miRNA_sample='/mnt/Storage/home/qinq/TCGA/COAD/COAD_Batch76_level3/miRNASeq/BCGSC__IlluminaGA_miRNASeq/Level_3/bcgsc.ca__IlluminaGA_miRNASeq__TCGA-A6-2671-01A-01T-1409-13__mirna_quantification.txt'
